                                        ...
                                        const relay_state_t *relay_state)
{
    ...
    /* TODO: Replace with actual Smart Load polling response frame. */
    tx_buf[0] = 'S';
    tx_buf[1] = 'L';
    tx_buf[2] = ',';
    tx_buf[3] = relay_state->relay_on ? '1' : '0';
    tx_buf[4] = ',';
    tx_buf[5] = (uint8_t)((int)measurement->voltage_v & 0xFF);
    tx_buf[6] = ',';
    tx_buf[7] = (uint8_t)((int)measurement->line_current_a & 0xFF);
    tx_buf[8] = '\r';
    tx_buf[9] = '\n';
    return 10U;
}
